                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="role_id" id="seller" value="1" required>
                                        <label class="form-check-label" for="seller">{{ __('Seller') }}</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="role_id" id="buyer" value="2" required>
