...
@section('content')
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" target="m-frame" href="{{ route('user.cart', ['userId' => Auth::user()->id]) }}">Orders</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" target="m-frame" href="#">About Us</a>
                </li>
                <li>
    ...
    <iframe src="" frameborder="0" name="m-frame" height="100vh" width="100%"></iframe>
@endsection
